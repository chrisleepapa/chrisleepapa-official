...
(() => {
  const PICKS = [
    ...
    {type:'VIDEO',icon:'▶',title:'FURIOUS',sub:'AI Music Video',desc:{ko:'생성형 AI 비주얼과 음악으로 제작한 Chris LEE.PAPA의 오리지널 영상 작품입니다.',en:'An original Chris LEE.PAPA video work created with generative AI visuals and music.'},image:'/images/og_share.png',href:'movie.html#furious',action:{ko:'영상 보기',en:'Watch Video'}},
