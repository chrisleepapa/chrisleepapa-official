...
(function(){
  ...
  const KO = {
    ...
    birth:['SISTER SQUAD는 2023년 겨울, 개인적으로 그리고 가족에게 큰 위기의 시간을 지나며 시작되었습니다.','그 시간을 극복하는 과정에서 신앙은 중요한 힘이 되어주었습니다. 동시에 가족의 사랑과 두 딸의 존재 자체가 다시 일어설 수 있는 가장 큰 힘이 되어주었습니다.','그 경험을 통해 가족이 서로에게 얼마나 큰 힘이 될 수 있는지를 깊이 생각하게 되었고, 그 마음이 SISTER SQUAD라는 이야기의 출발점이 되었습니다.'],
    futureTitle:'언젠가를 위한 이야기',
    future:['먼 훗날 엄마와 아빠가 늙고 병들어 아이들 곁에 오래 머물 수 없는 시간이 오더라도, 남겨진 두 자매가 서로의 손을 잡고 살아가기를 바라는 마음으로 이 이야기를 기획했습니다.','세상이 아무리 어렵고 현실의 벽이 아무리 높아도 서로를 의지하고, 함께 힘을 모아 시련을 넘어 한 걸음씩 앞으로 나아가기를 바라는 마음. 그것이 SISTER SQUAD를 관통하는 이야기의 뼈대입니다.'],
    heartTitle:'이야기를 움직이는 네 가지 마음',themes:['가족은 서로에게 힘이 됩니다.','두 자매는 서로를 지켜줍니다.','두려워도 함께 앞으로 나아갑니다.','시련을 넘어 한 걸음씩 나아갑니다.'],
  ...
  const EN = {
    lead:'A story about family, sisterhood, courage, and hope.',birthTitle:'A Story Born from Family Love',
    birth:['SISTER SQUAD began in the winter of 2023, during a deeply difficult season for me and my family.','Faith became an important source of strength as we worked through that time. At the same time, the love of family and the very presence of my two daughters gave me the greatest strength to stand again.','That experience made me think deeply about how much strength a family can give one another. That feeling became the starting point of SISTER SQUAD.'],
    futureTitle:'A Story for the Future',future:['I created this story with the hope that, even someday when Mom and Dad grow old and can no longer stay by their children’s side for long, the two sisters will still hold each other’s hands and keep moving forward together.','No matter how difficult the world becomes or how high the walls of reality may seem, I hope they will rely on each other, gather their strength, overcome every trial, and take the next step together. That is the foundation running through SISTER SQUAD.'],
    heartTitle:'Four Hearts That Drive the Story',themes:['Family gives us strength.','Two sisters protect one another.','Even when they are afraid, they move forward together.','They overcome hardship, one step at a time.'],
  ...
  function apply(lang){
    ...
    const hero=document.querySelector('.sq-hero');setText(hero&&hero.querySelector('.sq-lead'),d.lead);
  ...
  /* Force the Book 1 card to request the current sistersquad1.png asset.
     A new query value deliberately bypasses stale browser/CDN image cache. */
  const fixStyle=document.createElement('style');
  fixStyle.textContent=".sq-link:nth-child(1){background-image:url('/images/sistersquad1.png?v=20260828') !important}";
