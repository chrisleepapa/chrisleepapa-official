...
(() => {
  const PICKS = [
    ...
    {type:'VIDEO',icon:'▶',title:'FURIOUS',sub:'AI Music Video',desc:{ko:'Chris LEE.PAPA Movie Archive — AI 뮤직비디오 FURIOUS, 사랑한다고 MV 등 YouTube 영상 아카이브. Suno AI·생성형 AI 비주얼로 제작한 오리지널 영상 콘텐츠.',en:'Chris LEE.PAPA Movie Archive — a YouTube video archive featuring the AI music video FURIOUS, 사랑한다고 MV, and other original video content created with Suno AI and generative AI visuals.'},image:'https://img.youtube.com/vi/kAkGg2t1Ats/maxresdefault.jpg',href:'movie.html#furious',action:{ko:'영상 보기',en:'Watch Video'}},
    {type:'VIDEO',icon:'▶',title:'사랑한다고 MV',sub:'Music Video',desc:{ko:'Chris LEE.PAPA Movie Archive — AI 뮤직비디오 FURIOUS, 사랑한다고 MV 등 YouTube 영상 아카이브. Suno AI·생성형 AI 비주얼로 제작한 오리지널 영상 콘텐츠.',en:'Chris LEE.PAPA Movie Archive — a YouTube video archive featuring the AI music video FURIOUS, 사랑한다고 MV, and other original video content created with Suno AI and generative AI visuals.'},image:'/images/og_share.png',href:'movie.html#saranghandago',action:{ko:'영상 보기',en:'Watch Video'}},
    {type:'VIDEO',icon:'▶',title:'SISTER SQUAD Cinematic Trailer',sub:'Official Trailer',desc:{ko:'Chris LEE.PAPA Movie Archive — AI 뮤직비디오 FURIOUS, 사랑한다고 MV 등 YouTube 영상 아카이브. Suno AI·생성형 AI 비주얼로 제작한 오리지널 영상 콘텐츠.',en:'Chris LEE.PAPA Movie Archive — a YouTube video archive featuring the AI music video FURIOUS, 사랑한다고 MV, and other original video content created with Suno AI and generative AI visuals.'},image:'/images/og_share.png',href:'sistersquad.html',action:{ko:'트레일러 보기',en:'Watch Trailer'}},
