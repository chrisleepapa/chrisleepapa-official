...
(() => {
  const PICKS = [
    ...
    {type:'MUSIC',icon:'♫',title:'To The Space',sub:'Music Archive',spotifyAlbumId:'1JyYgZ8VTbh5mASNezCTcJ',desc:{ko:'Chris LEE.PAPA MUSIC ARCHIVE에 수록된 창작 음악 작품입니다.',en:'A creative music work from the Chris LEE.PAPA MUSIC ARCHIVE.'},href:'music.html',action:{ko:'음악 보기',en:'View Music'}},
